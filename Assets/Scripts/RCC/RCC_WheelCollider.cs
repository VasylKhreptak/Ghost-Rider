    ...
    void Awake()
    {
        ...
        if (!RCCSettings.dontUseAnyParticleEffects)
        {
            ...
            for (int i = 0; i < RCCGroundMaterials.frictions.Length; i++)
            {
                ...
                GameObject ps = _diContainer.InstantiatePrefab(RCCGroundMaterials.frictions[i].groundParticles);
                ...
                _diContainer.InstantiateComponent<ParticleSystemPauseController>(ps);
